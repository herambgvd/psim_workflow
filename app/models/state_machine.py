...
class StateDefinition(BaseModel):
    ...
    configuration, actions, and meta_data.
    """
    ...
    meta_data = Column(
        ...
        nullable=True,
        default=dict,
        doc="Additional meta_data for the state"
    )
...
class TransitionDefinition(BaseModel):
    ...
    meta_data = Column(
        ...
        nullable=True,
        default=dict,
        doc="Additional meta_data for the transition"
    )
...
class EventDefinition(BaseModel):
    ...
    payload_schema = Column(
        JSONB,
        nullable=True,
        doc="JSONB schema defining the expected event payload structure"
    )
    ...
    meta_data = Column(
        ...
        nullable=True,
        default=dict,
        doc="Additional meta_data for the event"
    )
